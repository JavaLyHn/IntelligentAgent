    ...
    >
      ...
      <Form form={form} layout="vertical" onFinish={handleSave}>
        ...
        <Form.Item name={['output', 'source']} noStyle>
          <Select placeholder="选择数据源" style={{ width: '100%' }} allowClear>
            {isTTSNode && <Option value="tts_audioUrl">超拟人音频合成.audioUrl</Option>}
            {isLLMNode && <Option value="llm_output">大模型输出.text</Option>}
          </Select>
        </Form.Item>
